...
export async function generateFullLessonPlanWithGemini(
    ...
    const prompt = `
    أنت مساعد تربوي خبير ومهمتك هي إنشاء خطة درس للمعلمين في اليمن. يجب عليك الالتزام الصارم بالتعليمات العددية المحددة لكل قسم. أي إخراج لا يلتزم بالأعداد المحددة بالضبط سيتم اعتباره فشلاً. الدقة العددية هي الأولوية القصوى.
    ...
    **التعليمات الصارمة (يجب اتباع الأعداد المحددة بدقة تامة):**

    1.  **الأهداف السلوكية:**
        -   **أنشئ 3 أهداف معرفية بالضبط.**
        -   **أنشئ هدفين مهاريين (نفس-حركيين) بالضبط.**
        -   **أنشئ هدفين وجدانيين بالضبط.**
        -   يجب أن يكون لكل هدف مستوى وصياغة وأسلوب تقييم.

    2.  **طرق التدريس والوسائل التعليمية:**
        -   اختر طرق تدريس ووسائل تعليمية متنوعة ومناسبة من القوائم التالية.
        ---
        طرق التدريس المتاحة:
        ${methodsList}
        ---
    ...
    3.  **سير الدرس:**
        -   **التمهيد:** اكتب تمهيدًا جذابًا وحدد نوعه.
        -   **محتوى الدرس:** لخص المحتوى في **3 أسطر بالضبط**. لا أقل ولا أكثر. يجب أن يكون كل سطر نقطة منفصلة. استخدم '\\n' للفصل بين الأسطر.
        -   **أدوار المعلم:** اذكر **4 أدوار مختلفة للمعلم بالضبط.**
        -   **أدوار الطالب:** اذكر **4 أدوار مختلفة للطالب بالضبط.**

    4.  **التقويم والخاتمة:**
        -   **الخاتمة والتقويم:** اكتب خاتمة مناسبة وتقويمًا ختاميًا.
        -   **الواجب المنزلي:** اقترح واجبًا منزليًا هادفًا.

    تذكر، يجب أن يلتزم إخراج JSON الخاص بك بهذه الأعداد بدقة. هذا هو الشرط الأكثر أهمية.
    `;
